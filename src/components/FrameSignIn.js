const FrameSignIn = () => {
  return (
    <div className="w-[720px] flex flex-col items-center justify-start pt-[463px] pb-[68px] pr-[161px] pl-5 box-border relative gap-[357px] min-w-[720px] max-w-full text-left text-53xl text-light-gohan font-montserrat lg:flex-1 mq1050:pt-[301px] mq1050:pb-11 mq1050:box-border mq1050:min-w-full mq450:pt-[196px] mq450:pb-[29px] mq450:box-border mq750:gap-[178px] mq750:pr-20 mq750:box-border">
      <div className="flex flex-row items-start justify-start py-0 pr-0 pl-[19px]">
        <h1 className="m-0 h-[88px] relative text-inherit font-bold font-inherit inline-block z-[2] mq1050:text-39xl mq450:text-24xl">
          BASE
        </h1>
      </div>
      <div className="w-[299px] flex flex-row items-center justify-between py-0 pr-px pl-0 box-border gap-[20px] z-[2]">
        <img
